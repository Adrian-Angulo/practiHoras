...
const pacing_engine_service_js_1 = require("./modules/metricas/domain/services/pacing-engine.service.js");
const registro_calculo_service_js_1 = require("./modules/registros/domain/services/registro-calculo.service.js");
const profile_entity_js_1 = require("./modules/profile/domain/entities/profile.entity.js");
...
const h1 = registro_calculo_service_js_1.RegistroCalculoService.calcularHorasComputables('08:00', '13:00', 0);
assert(h1 === 5.0, '08:00 a 13:00 sin almuerzo = 5.0 hrs', `Obtenido: ${h1}`);
const h2 = registro_calculo_service_js_1.RegistroCalculoService.calcularHorasComputables('08:00', '17:00', 60);
assert(h2 === 8.0, '08:00 a 17:00 con 60 min almuerzo = 8.0 hrs', `Obtenido: ${h2}`);
const h3 = registro_calculo_service_js_1.RegistroCalculoService.calcularHorasComputables('09:30', '13:45', 15);
assert(h3 === 4.0, '09:30 a 13:45 con 15 min descuento = 4.0 hrs', `Obtenido: ${h3}`);
try {
    registro_calculo_service_js_1.RegistroCalculoService.calcularHorasComputables('14:00', '12:00', 0);
...
const mockProfile = {
    ...
    fechaFin: '2026-06-30',
    horarioSemanal: profile_entity_js_1.defaultHorarioSemanal,
};
const mockRegistros = [
    {
        id: 'reg-1',
...
const metricas = pacing_engine_service_js_1.PacingEngineService.calcularMetricas(mockProfile, mockRegistros, simulatedNow);
...
const profileSinFechas = {
    ...mockProfile,
    fechaInicio: null,
    fechaFin: null,
};
const metricasSinFechas = pacing_engine_service_js_1.PacingEngineService.calcularMetricas(profileSinFechas, mockRegistros, simulatedNow);
...
console.log(`======================================================\n`);
//# sourceMappingURL=test-mobile-compliance.js.map